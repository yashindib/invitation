  ...
  return (
    <section className="relative overflow-hidden bg-cream px-6 py-24 sm:py-32">
      ...
      <div className="relative z-10 mx-auto max-w-5xl">
        ...
        {/* featured: animated bride & groom + intro */}
        <div className="mt-12 grid items-center gap-8 sm:grid-cols-2">
          <Reveal y={50}>
            <div className="relative aspect-[4/5] overflow-hidden rounded-2xl shadow-rose-lg">
          ...
          {config.customs.map((c, i) => (
            <Reveal key={c.name} delay={(i % 2) * 0.1}>
              <div className="flex h-full items-start gap-5 rounded-2xl glass-blush p-6 shadow-petal sm:p-7">
                <div className="flex h-14 w-14 shrink-0 items-center justify-center rounded-full border border-rim bg-ivory">
